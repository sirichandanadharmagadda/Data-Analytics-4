SELECT TOP (1000) [transaction_id]
      ...
      ,[purchase_date]
      ,[delivery_status]
  FROM [ECOMMERCE_DATASET].[dbo].[ecommerce_transactions_dataset]
...
INSERT INTO product_details2 (product_category, average_price, total_stock, brand_popularity) VALUES
...
INNER JOIN product_details2 pd 
...
SELECT 
    ...
    et.user_id
FROM ecommerce_transactions_dataset et
RIGHT JOIN product_details2 pd 
ON et.product_category = pd.product_category;
--c.Write subqueries
SELECT * 
FROM ecommerce_transactions_dataset
